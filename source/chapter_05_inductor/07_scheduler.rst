...
.. figure:: /_static/figures/scheduler_fusion.svg
   :align: center
   :alt: Scheduler 融合与调度流程
   :figwidth: 100%

   Scheduler 将 IRNode 包装为 SchedulerNode，通过依赖分析和迭代融合生成 FusedSchedulerNode，最后分发到对应后端的 codegen。
